...
import dev.pioruocco.model.StudentJdbc;
...
import dev.pioruocco.listener.SkipListener;
import dev.pioruocco.listener.SkipListenerImpl;
import dev.pioruocco.model.StudentCsv;
import dev.pioruocco.model.StudentJson;
import dev.pioruocco.model.StudentXml;
import dev.pioruocco.processor.FirstItemProcessor;
import dev.pioruocco.reader.FirstItemReader;
import dev.pioruocco.writer.FirstItemWriter;
...
public class SampleJob {
	...
	private Step firstChunkStep() {
		return stepBuilderFactory.get("First Chunk Step")
				.<dev.pioruocco.postgresql.entity.Student, Student>chunk(3)
	...
	*/
	...
	@StepScope
	@Bean
	public JpaCursorItemReader<dev.pioruocco.postgresql.entity.Student> jpaCursorItemReader(
			@Value("#{jobParameters['currentItemCount']}") Integer currentItemCount,
			@Value("#{jobParameters['maxItemCount']}") Integer maxItemCount) {
		JpaCursorItemReader<dev.pioruocco.postgresql.entity.Student> jpaCursorItemReader =
				new JpaCursorItemReader<dev.pioruocco.postgresql.entity.Student>();
